...
class Mime
{
     ...
     * @return string|null
     */
    public static function fix(string $file, string|null $mime = null, string|null $extension = null): ?string
    {
        // fixing map
        $map = [
            'text/html' => [
     ...
     */
    public static function type(string $file, string|null $extension = null): false|string|null
    {
