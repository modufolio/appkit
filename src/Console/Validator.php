...
final class Validator
{
    ...
    public static function validateDoctrineFieldName(string $name, Connection $connection): string
    {
        // check reserved words
        if ($connection->getDatabasePlatform()->getReservedKeywordsList()->isKeyword($name)) {
