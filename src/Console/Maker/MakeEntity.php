...
use Modufolio\Appkit\Console\Doctrine\EntityRegenerator;
...
final class MakeEntity extends AbstractMaker
{
    ...
    {
        return 'Create or update a Doctrine entity class';
    }
    ...
    public function generate(InputInterface $input, ConsoleStyle $io, Generator $generator): void
    {
        ...
        $this->writeSuccessMessage($io);
        $io->text([
            \sprintf('Next: When you\'re ready, create a migration with <info>%s migrations:diff</info>', CliOutputHelper::getCommandPrefix()),
            '',
        ]);
    }
    ...
    private function askForNextField(ConsoleStyle $io, array $fields, string $entityClass, bool $isFirstField): EntityRelation|ClassProperty|null
    {
        ...
        $fieldName = $io->ask($questionText, null, function ($name) use ($fields) {
            ...
            return Validator::validateDoctrineFieldName($name, $this->doctrineHelper->getConnection());
        });
