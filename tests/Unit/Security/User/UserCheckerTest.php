...
class UserCheckerTest extends TestCase
{
    ...
    public function testDisabledCheckTakesPrecedenceOverLocked(): void
    {
        ...
        $user = new class () implements LockableUserInterface {
            ...
            public function getEmail(): string { return 'u@example.com'; }
            public function getRoles(): array { return ['ROLE_USER']; }
            public function getUserIdentifier(): string { return 'u@example.com'; }
            public function eraseCredentials(): void {}
            public function isEnabled(): bool { return false; }
            public function isLocked(): bool { return true; }
            public function getLockedAt(): ?\DateTimeImmutable { return null; }
            public function getLockedReason(): ?string { return null; }
        };
    ...
    private function plainUser(bool $enabled): UserInterface
    {
        return new class ($enabled) implements UserInterface {
            ...
            public function getId(): int { return 1; }
            public function getEmail(): string { return 'plain@example.com'; }
            public function getRoles(): array { return ['ROLE_USER']; }
            public function getUserIdentifier(): string { return 'plain@example.com'; }
            public function eraseCredentials(): void {}
    ...
    private function lockableUser(bool $locked, ?string $reason = null): LockableUserInterface
    {
        return new class ($locked, $reason) implements LockableUserInterface {
            ...
            public function getEmail(): string { return 'lockable@example.com'; }
            public function getRoles(): array { return ['ROLE_USER']; }
            public function getUserIdentifier(): string { return 'lockable@example.com'; }
            public function eraseCredentials(): void {}
            public function isEnabled(): bool { return true; }
            public function isLocked(): bool { return $this->locked; }
            public function getLockedAt(): ?\DateTimeImmutable { return $this->locked ? new \DateTimeImmutable() : null; }
            public function getLockedReason(): ?string { return $this->reason; }
        };
    }
    ...
    private function expirableUser(bool $expired): ExpirableUserInterface
    {
        return new class ($expired) implements ExpirableUserInterface {
            ...
            public function getEmail(): string { return 'expirable@example.com'; }
            public function getRoles(): array { return ['ROLE_USER']; }
            public function getUserIdentifier(): string { return 'expirable@example.com'; }
            public function eraseCredentials(): void {}
            public function isEnabled(): bool { return true; }
            public function isAccountExpired(): bool { return $this->expired; }
            public function getAccountExpiresAt(): ?\DateTimeImmutable { return $this->expired ? new \DateTimeImmutable('-1 day') : null; }
        };
    }
    ...
    private function credentialsExpirableUser(bool $expired): CredentialsExpirableUserInterface
    {
        return new class ($expired) implements CredentialsExpirableUserInterface {
            public function __construct(private bool $expired) {}
            public function getId(): int { return 4; }
            public function getEmail(): string { return 'creds@example.com'; }
            public function getRoles(): array { return ['ROLE_USER']; }
            public function getUserIdentifier(): string { return 'creds@example.com'; }
            public function eraseCredentials(): void {}
            public function isEnabled(): bool { return true; }
            public function isCredentialsExpired(): bool { return $this->expired; }
            public function getCredentialsExpireAt(): ?\DateTimeImmutable { return $this->expired ? new \DateTimeImmutable('-1 day') : null; }
        };
    }
}
