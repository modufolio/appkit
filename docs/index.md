...
- Background jobs via RoadRunner's first-party jobs plugin — no queue abstraction of its own, by design; see [Deployment](deployment.md#background-jobs)
